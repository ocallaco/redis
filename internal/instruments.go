...
func init() {
	defer func() {
		if r := recover(); r != nil {
			Logger.Printf(context.Background(), "Error creating meter github.com/ocallaco/redis for Instruments", r)
		}
	}()

	meter := metric.Must(global.Meter("github.com/ocallaco/redis"))
